...
from tbvaccine import TBVaccine, __version__
...
def main():
    ...
    parser.add_argument("-V", "--version", action="store_true", help="show the version and quit")
    ...
    tbv = TBVaccine(code_dir=args.dir, isolate=args.dont_isolate)
